...
window.TalentFlowAuth = {
  ...
  async register(name, email, password) {
    ...
    // on signup, and the SIGNED_IN handler above fills in fullName/role
    // for real once the person confirms and a session exists. Kept here
    // too in case email confirmation is turned off for this project, in
    // which case a session (and this write) both happen immediately.
